// Script de prueba simple para IA adaptativa PPTX
// Ejecutar con: node test-pptx-ai.js

// Simular el servicio de IA adaptativa
class SimpleAdaptiveTest {
  constructor() {
  ...
  runTests() {
    ...
    // Prueba 4: Texto largo
    console.log('\n📖 Prueba 4: Texto Largo');
    const longText = 'A'.repeat(800); // Texto muy largo
    const longContent = [
    ...
    results.push({ test: 'Texto Largo', passed: longDecisions.fontScale < 1.0 || longDecisions.shouldSplit });
...
// Ejecutar pruebas
const tester = new SimpleAdaptiveTest();
tester.runTests();